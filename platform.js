...
(function(){
  ...
  async function buildMenu(){
    ...
    drawer.innerHTML='<div class="pp-drawer-head"><div class="pp-drawer-brand">فلسطين <span>بلاتفورم</span></div><button id="ppMenuClose" class="pp-drawer-close" aria-label="إغلاق">×</button></div>'+
      ...
      '<div class="pp-menu-section pp-main-menu">'+link('index.html','🏠','الرئيسية')+link('ads.html','📢','الإعلانات')+link('services.html','⚡','الخدمات')+link('map.html','🗺️','الخريطة والمواقع')+link('favorites.html','❤️','المفضلة')+link('messages.html','💬','المحادثات')+link('notifications.html','🔔','الإشعارات')+link('orders.html','🛍️','طلباتي ومشترياتي')+link('subscriptions.html','⭐','الاشتراكات')+'</div>'+
