...
(function(){
    ...
    try{
      ...
      if(u){
        ...
        menu.innerHTML='<div class="pp-profile-head"><div><b>'+name+'</b><small>حسابك في فلسطين بلاتفورم</small></div></div>'+
          link('account.html','👤','حسابي')+link('my-ads.html','📋','إعلاناتي')+link('favorites.html','❤️','المفضلة')+link('messages.html','💬','الرسائل')+link('orders.html','🛍️','طلباتي ومشترياتي')+(isAdmin?link('admin.html','👑','لوحة المدير')+link('orders-admin.html','📦','إدارة الطلبات والتوصيل'):'')+
  ...
  async function buildMenu(){
    ...
    drawer.innerHTML='<div class="pp-drawer-head"><div class="pp-drawer-brand">فلسطين <span>بلاتفورم</span></div><button id="ppMenuClose" class="pp-drawer-close" aria-label="إغلاق">×</button></div>'+
      ...
      '<div class="pp-menu-section"><div class="pp-menu-title">حسابك</div>'+link('account.html','👤','حسابي')+link('my-ads.html','📋','إعلاناتي')+link('my-places.html','📍','أماكني')+link('messages.html','💬','الرسائل')+link('favorites.html','❤️','المفضلة')+link('orders.html','🛍️','طلباتي ومشترياتي')+'</div><div class="pp-menu-divider"></div><div id="ppMenuAuth"></div>';
